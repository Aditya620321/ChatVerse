		...
		<div className="w-full min-h-32  shadow-gray-950 shadow-inner flex flex-col justify-between items-start px-4 py-8 bg-slate-800 text-white">
			...
			<div className="flex items-center justify-start w-full p-4 flex-wrap">
				<div className="flex flex-col min-w-[280px] w-[33%] my-3">
					...
					<span>Aditya Shashank</span>
					<span>Kolkata, West Bengal</span>
					<span>Pincode - 700102</span>
					<span>
						<Link
							to={"mailto:contact.shashankaditya930@gmail.com"}
							target="_blank"
							className="hover:text-blue-600 hover:underline"
						>
							contact.shashankaditya930@gmail.com
						</Link>
					</span>
				</div>
				<div className="flex flex-col min-w-[280px] w-[33%] my-3">
				...
				<div className="flex flex-col min-w-[280px] w-[33%] my-3">
					...
					<span>
						<a
							className="hover:text-blue-600 hover:underline"
							href="https://www.linkedin.com/in/aditya-shashank-02a102249/"
							target="_blank"
							rel="noreferrer"
						>
							LinkedIn
					...
					<span>
						<a
							className="hover:text-blue-600 hover:underline"
							href="https://github.com/Aditya620321"
							target="_blank"
							rel="noreferrer"
						>
							Github
					...
					<span>
						<a
							className="hover:text-blue-600 hover:underline"
							href="mailto:contact.shashankaditya930@gmail.com"
							target="_blank"
							rel="noreferrer"
						>
							E-Mail
			...
			<h1 className="font-bold">
				All rights reserved 2025 &copy; ChatVerse
			</h1>
		</div>
	);
};
